        ...
        <div className="contact-card reveal">
          <div className="contact-layout">
            ...
            <div className="contact-actions">
              <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="btn-contact-whatsapp">
              ...
              <a href="tel:+79278595957" className="contact-item">
                <span className="contact-item-icon">📞</span>
                +7 927 859-59-57
              </a>

              <a href="tel:+79288441663" className="contact-item">
                <span className="contact-item-icon">📱</span>
                +7 928 844 1663
              </a>

              <a href="https://instagram.com/rwnah_kh" target="_blank" rel="noreferrer" className="contact-item">
                <span className="contact-item-icon">📸</span>
                @rwnah_kh
              </a>
